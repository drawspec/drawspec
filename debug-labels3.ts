...
// Multi-segment: (0,0)→(40,20)→(140,220)
...
console.log("MULTI-SEG: y=" + r1.y + " h=" + r1.h + " sw=" + r1.sw);
console.log("  visualTop=" + (r1.y - r1.sw) + " visualBottom=" + (r1.y + r1.h + r1.sw));
console.log("  edgeY at label range: seg2 at x=" + r1.x + " => Y=" + (20 + ((r1.x - 40)/100)*200));
console.log("  seg2 at x=" + (r1.x + r1.w) + " => Y=" + (20 + ((r1.x + r1.w - 40)/100)*200));
// The label visual range is 56.4-76.4, edge Y at label center is 100 => distance = 23.6
console.log("  distance from edge Y=100: visualBottom(76.4) < 100, so dist = " + (100 - (r1.y + r1.h + r1.sw)));
...
console.log("\nHORIZONTAL: y=" + r2.y + " h=" + r2.h + " sw=" + r2.sw + " centerY=" + (r2.y + r2.h/2));
console.log("  visualTop=" + (r2.y - r2.sw) + " visualBottom=" + (r2.y + r2.h + r2.sw));
console.log("  edgeY=100, distance = " + (100 - (r2.y + r2.h + r2.sw)));
